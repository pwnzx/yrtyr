        ...
        <div class="container">
            <div class="row">
                <div class="col-6 px-0 px-md-3 pl-1 py-3">
                    <span class="call-top"></span> <a href="#" class="call-top">+7819668481474</a>
                </div>
...
<div class="section main-banner over-hide z-bigger">
    ...
    <div class="parallax parallax-top" style="background-image: url(./assets/images/mariana-medvedeva-usfie5yc7py-unsplash.jpg); width: 100%;"></div>
